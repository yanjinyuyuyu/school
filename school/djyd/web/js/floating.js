(function($){
    ...
    AdFloat.prototype={
        init:function(){
            ...
            me.element.hover(function(){clearInterval(me.interval);$("#head").css("display","block")},function(){me.interval=setInterval(function(){me.changePos();$("#head").css("display","none")},me.options.delay);});
